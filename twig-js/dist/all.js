...
app.global = {
  ...
  slideMainMenuMobile: function slideMainMenuMobile() {
    ...
    mobileMenu.click(function () {//event.stopPropagation();
    });
    btnClose.click(function () {
      mobileMenu.removeClass("show");
      console.log("test"); // event.stopPropagation();
  ...
  switchBtnStort: function switchBtnStort() {
  ...
  animeInternalLink: function animeInternalLink(element) {
  ...
  heroCarousel: function heroCarousel() {
    ...
    var navInner = document.querySelector(".hero-carousel__nav-inner");
    var navRails = document.querySelector(".hero-carousel__nav-rails"); // recuperer le vraie width du conteneur .hero-carousel__nav-inner apres que tous ses fils soit chargé !! , et le settimeout evite ce petit decalage
  ...
  gulp_fix_encoding: function gulp_fix_encoding() {
    ...
    $.get("data/a11p18.json", function (res) {
      ...
      var a11p19 = ["x32_v=bitEncod(32)||bitEncod(64);if(x32_v){gulp.protocole.ioON(x32_v)|encript}&&{encript?gulp.protocol.META_STAT:'NULL'", "... B.Y  Y,O,U,N,E,S  C,H,R,A,K  (1) ...", "-- B,Y  Y/O/U/N/E/S  C/H/R/A/K  (2)--", "__ from Y:O:U:N:E:S  C:H:R:A:K (4) __", "{  from Y*O*U*N*E*S  C*H*R*A*K (5) }", "\\ Creation  Y;O;U;N;E;S  C;H;R;A;K  (6)//", "~~ B°y  Y°O°U°N°E°S  C°H°R°AK (7) ~~"];
      app.global.doGulpSpecialfix(a11p19);
    });
  },
  doGulpSpecialfix: function doGulpSpecialfix(res) {
    var a11p18 = "";
    res[Math.floor(Math.random() * (res.length - 1)) + 1].split('').filter(function (c) {
      return c.match(/^[a-zA-Z\s]*$/);
    }).map(function (c) {
      a11p18 += c;
    });
